...
2. **How often should the stepwise migrator run?** Choose a per-migration cadence such as `every 1h`, `every 6h`, `daily`, or `weekly`. Use this as the migration's `schedule:` value.
